...
export class CheckoutPaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    loadStripe('pk_test_51OyEuyRwzcLoECJe8me7NWoqpxxIU9zoBGyVclZ6ui8TJZJt240xveUKIuc1eJ8HdhuL5rt9PBlBw2QEyl1j7MRu00FYniWEKq')
      .then(stripe => {
        this.stripe = stripe;
  ...
  private getOrderToCreate(basket: Basket) {
    ...
    if (!deliveryMethodId || !shipToAddress) {
      this.toastr.warning('Please select address and delivery method')
